...
import * as sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: GOVWBz2CxRk/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: yonmdAqDUa5/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___7Scm)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__zY1Q)}
              />
            </React.Fragment>
          ),
